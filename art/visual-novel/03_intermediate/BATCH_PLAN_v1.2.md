...
| B3 | 2 战斗 CG + 17 剧情 CG | R0 19/19、R1 身份 19/19；R2/R3/R4 0/19 | 角色和对应环境均已通过 |
...
- 20 张 GAL 环境母版已全部通过并写入 SHA-256；19 张活动 CG 场景卡均已完成 R0 布局与 R1 身份锁定。
- `CG_001–CG_019` 当前统一停在 R1；两张战斗预测构图区分明确，序章塔景保留“七灯、单船、封门、右侧风暴”锁定项。下一门槛为 R2 服装、配饰与关键道具精确校验。
