...
function installDialogues(dialogues) {
  Object.assign(dialogues, {
    floor21: sequence('第二十一阵：余烬登记库', [
      ...
      turn('残响精灵·纱雾', 'guide', '逐页校验章程先解决“真回执被当成伪件”。两张星蚀卡可以打开校验内室；在那里建立逐项对照表后，我们不仅会得到更稳定的攻防，还能提前拆掉最后两具守卫的一部分生命、防护和魔法反击。', { expression: 'focus' }),
      turn('残响精灵·纱雾', 'guide', '灯塔接力章程先解决“结案发出去却没人收到”。日曜、月辉各一张可以重接三座哨站；完成后，共鸣回路会扩容并立即充能。等我们在接力校场真正拿下总管，它还能再完整补给一次——代价是这条路不会直接削弱最后的守卫。', { expression: 'focus' }),
