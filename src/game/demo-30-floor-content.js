...
function installDialogues(dialogues) {
  Object.assign(dialogues, {
    ...
    floor25: sequence('第二十五阵：缺页庭', [
      turn('旁白', null, '接力导体停止拦截后，一号哨站的回音被收进灯塔索引。可当索引想添上“已收到”，登记库立刻亮起红印：主卷中找不到允许改写状态的条款。错误指向了上方的缺页庭。', { kind: 'narration' }),
    ...
    floor27: sequence('第二十七阵：接力校场', [
      ...
      turn('残响精灵·纱雾', 'guide', '但签过名字并不等于这段见证已经完成。那位同行者还要亲自取回能证明经历的信物，并从起源魔源前的共鸣会战中活着回来。只有她真正走完这条路，结案以后才可能留下自己的亲笔留下的话；否则档案不会替她编造一页不存在的证词。', { expression: 'focus' }),
