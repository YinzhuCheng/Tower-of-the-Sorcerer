...
function installDialogues(dialogues) {
  Object.assign(dialogues, {
    floor21: sequence('第二十一阵：余烬登记库', [
      ...
      turn('残响精灵·纱雾', 'guide', '现在可以把整条错误链说完整了：奥术主权者删去三日期限，起源核心挪用三席旧确认，虚空先驱又截走抵达回执。不是灰港没有结案，是本该送到一起的证据和收尾步骤被一环环拆散了。', { expression: 'focus' }),
    ...
    floor23: sequence('第二十三阵：逐页校验室', [
      ...
      turn('旁白', null, '水镜里，最后一艘撤离船的缆绳离开灰港，半夜前抵达北岸。船长报出“四十七人全部抵达北岸”时，澜音的鲸歌在背景里给出了回应；声音、船号和港务时钟三者恰好对上。', { kind: 'narration' }),
