...
function installDialogues(dialogues) {
  Object.assign(dialogues, {
    floor21: sequence('第二十一阵：余烬登记库', [
      ...
      turn('残响精灵·纱雾', 'guide', '现在可以把整条错误链说完整了：奥术主权者删去三日期限，起源核心挪用三席旧确认，虚空先驱又截走抵达回执。不是灰港没有达到结束救援的条件，而是本该送到一起的证据和收尾步骤被一环环拆散了。', { expression: 'focus' }),
      ...
      turn('无声女王·诺克缇娅', 'final_queen', '我封塔，是因为我以为警报一停，这些名字就会被当成从未存在。现在我才看见，真正没有被听见的，恰恰是他们已经抵达安全地、已经罹难，或仍需查找的不同回答。', { expression: 'sorrow' }),
    ...
    floor30: sequence('第三十阵：余烬灯塔', [
      ...
      turn('奥术主权者', 'arcane_sovereign', '别再往黑暗里找第四个人了。三日期限是我删的；三席那枚“同意”是核心拿旧回答补出来的；真正的抵达回执，则被虚空先驱按我留下的错误命令截进了上层封印。走到这里，我们已经把每一只手都看见了。', { expression: 'regret' }),
