...
function installDialogues(dialogues) {
  Object.assign(dialogues, {
    floor21: sequence('第二十一阵：余烬登记库', [
      ...
      turn('残响精灵·纱雾', 'guide', '现在可以把整条错误链说完整了：奥术主权者删去三日期限，起源核心挪用三席旧确认，虚空先驱又截走抵达回执。灰港早就具备停止救援的条件。问题在于，本该送到一起的证据和收尾步骤被一环环拆散了。', { expression: 'focus' }),
    ...
    ending: sequence('终章：未投递的信', [
      ...
      turn('无声女王·诺克缇娅', 'final_queen', '已抵达不等于从此无事，已罹难也不等于只留一个句号。前者还要确认在新居所的安置，后者要把消息和遗物送到家人手中，待核实的名字则要在每个复查日之后带着新证据继续查。“结案”结束的是那道无限命令，不是对人的后续照顾。', { expression: 'knowing' }),
