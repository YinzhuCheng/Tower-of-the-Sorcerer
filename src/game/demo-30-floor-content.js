...
function installDialogues(dialogues) {
  Object.assign(dialogues, {
    ...
    ending: sequence('终章：未投递的信', [
      ...
      turn('绫星·璃', 'hero', '璃抱起最上面一只信匣。它比任何一枚核心都轻，里面却装着三年来始终没有抵达收件人手里的声音。她试着哼了一下重新完整的七段咏唱，最后没有把它唱成命令，只把信匣抱稳了一点。\n\n“记录留下，命令结束；新的求援有人接，旧的错误也找得到来路。走吧，去送第一批回信。”', { expression: 'resolve' }),
