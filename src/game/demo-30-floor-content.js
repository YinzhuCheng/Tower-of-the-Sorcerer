...
function installDialogues(dialogues) {
  Object.assign(dialogues, {
    ...
    floor30: sequence('第三十阵：余烬灯塔', [
      ...
      turn('残响精灵·纱雾', 'guide', '三套修复章程不会在灯塔里突然一起生效。你在余烬登记库选定、并亲手完成侧库修复的那一套，会保留到最后两战；接力校场最先锁定的备用程序则在它之外再提供一层支援。两份准备可以来自不同方向。开战前先查看敌人详情，确认这些准备已经真实反映在守望者和核心的状态上。', { expression: 'focus' }),
