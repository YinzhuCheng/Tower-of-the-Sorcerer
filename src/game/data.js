  ...
  prologue: {
    ...
    turns: [
      ...
      },
      {
        kind: 'narration',
        speaker: '旁白',
        text: '灰港没有能力单独组织数千人的撤离。城边的高塔因此临时接管了整场行动：门廊辨认来者，名册记录谁上了哪艘船，导航台引船穿过风暴，巡卫保护通道，炉心给避难屋供暖，星镜核对记录，最后一道印权则记录每一道命令由谁发出、何时应该结束。'
      },
      {
        kind: 'narration',
        speaker: '旁白',
      ...
      },
      {
        kind: 'narration',
        speaker: '旁白',
        text: '真正的问题发生在封锁之后。诺克缇娅一直没有收到她认定有效的“全员安全”回执。她看到的登记网仍有四十七个人处在“等待确认”，于是她不敢结束紧急状态。她害怕警报一停，旧规就会把这些未结案的名字一起抹掉。'
      },
      {
        speaker: '绫星·璃',
        portrait: 'hero', expression: 'guarded',
        text: '北岸的纪念册里有北辰七号的完整乘员名单，连当年最后四十七个人后来住在哪个街区都能查到。外面的世界知道他们到了；只有塔里的记录还坚持说，他们“下落未确认”。这不是普通的资料缺失，是塔外与塔内对同一批人的记载得出了相反的结果。'
      },
      {
        kind: 'narration',
        speaker: '旁白',
      ...
      },
      {
        ...
        text: '我能确定的是，那张回执来过。它进过导航回路，只是没走到该去的终点。璃，你先记住一件事：把一场救援结案，不是把人和档案擦掉。真正该做的，是先弄清每个人后来去了哪里，再让那些只适用于灾难当夜的命令停下来。'
      },
      {
        speaker: '残响精灵·纱雾',
        portrait: 'guide', expression: 'watchful',
      ...
      },
      {
        speaker: '残响精灵·纱雾',
        portrait: 'guide', expression: 'gentle',
        text: '而每拿回一枚核心，你不仅会恢复一段魔力，也会得到那一层保存的原始记录。第一层可能只有一段出发录音，第二层可能只有一页名单；单看都不足以下结论，可把它们按时间接起来，就能重新回答“那一夜到底发生了什么”。'
      },
      {
        speaker: '绫星·璃',
        portrait: 'hero', expression: 'guarded',
