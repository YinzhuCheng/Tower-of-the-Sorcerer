...
export const DIALOGUES = {
  ...
  floor6: {
    ...
    turns: [
      ...
      { speaker: '绫星·璃', portrait: 'hero', expression: 'guarded', text: '这就是我们现在必须分开的两件事：“保存记录”和“继续执行救援命令”本来就不是一回事。诺克缇娅害怕关掉命令会删掉名字，所以一直不敢关；真正该查的是，是谁锁死了归档的入口，逼她只能在这两个结果里选。' },
      ...
      { speaker: '残响精灵·纱雾', portrait: 'guide', expression: 'focus', text: '按新月、半月、满月的顺序启动星镜。第六枚天穹核心不仅能恢复璃的校验咏唱，也会揭开被藏住的命令来路。等我们知道“谁不让归档”，第七层才能继续追那道命令从哪里来。' }
    ]
  },
  floor7: {
    title: '第七阵：虚影织界',
