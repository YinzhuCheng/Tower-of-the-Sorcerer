...
export const DIALOGUES = {
  ...
  floor6: {
    title: '第六阵：星镜书库',
    turns: [
      { speaker: '旁白', portrait: null, text: '赤焰日志把时间线又补完整了一段：北辰七号的回执先进入高塔，随后王庭收到一条压过原令的“继续救援”新命令，供暖、警戒和登记因此没有转入结束阶段。第六层星镜书库保存的，正是这些命令彼此冲突时的校验记录。' },
      { speaker: '旁白', portrait: null, text: '天穹魔女·露米是书库的守护者，也是王庭的演算员。她的职责不是替女王决定对错，而是把不同选择会造成的后果算给她看。三年来，她的星镜里反复出现同样的两个结局。' },
      { speaker: '天穹魔女·露米', portrait: 'astral_boss', text: '第一条路：停止登记网。旧规会把所有“未结案”的名字当成临时条目抹掉。第二条路：继续登记网。名字留下，但守卫、炉火、警报和门锁也会继续服从救援状态。' },
      ...
      { speaker: '绫星·璃', portrait: 'hero', expression: 'resolve', text: '我们已经有船长原音、完整名册、被改过的封锁副本和异常供能日志。把这些放在同一条时间线上，星镜就能看出是哪一道更高的命令在回执出现之后插进来的。' },
