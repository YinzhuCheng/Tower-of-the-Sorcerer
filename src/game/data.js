...
export const DIALOGUES = {
  prologue: {
    ...
    title: '序章：被夺去的咏唱',
    text: '大魔术师绫星·璃在决斗中被“无声女王”夺走全部魔力。\n\n女王把七枚魔力核心嵌入层叠魔法阵，令各派少女守卫失去自我。璃只能以凡人的体力、剑术与判断进入阵中——每夺回一枚核心，她便会取回一部分魔力。'
  },
  floor2: {
    speaker: '绫星·璃', portrait: 'hero', title: '第二阵：森罗回廊',
    text: '月影核心回到了体内。微弱的感知告诉我：这里的狐娘并非自愿阻拦。先破解藤蔓机关，再寻找下一枚核心。'
  },
  floor3: {
    speaker: '残响精灵·纱雾', portrait: 'guide', title: '第三阵：深蓝回廊',
    text: '潮汐结界由两枚水纹开关共同维持。两处都被激活后，主通路才会解封。魔法伤害会无视防御，请预留足够生命。'
  },
  floor4: {
    speaker: '绫星·璃', portrait: 'hero', title: '第四阵：锋刃庭院',
    text: '这里的剑士不依靠法术。固定数值不会说谎：攻击不足便无法破防，防御足够则能让多数剑击归零。先算，再战。'
  },
  floor5: {
    speaker: '龙姬·焰璃', portrait: 'dragon_boss', title: '第五阵：赤焰龙脉',
    text: '“失去魔法还敢继续向上？那就证明你的意志能穿过龙火。”\n\n焰璃的声音仍保有清醒。她似乎在等待一个能斩断强制契约的人。'
  },
  floor6: {
    speaker: '天穹魔女·露米', portrait: 'astral_boss', title: '第六阵：星镜书库',
    text: '镜门只接受正确的星序：新月、半月、满月。踩错符文会让序列归零，但不会消耗资源。'
  },
  floor7: {
    speaker: '影织姬·鸦羽', portrait: 'shadow_boss', title: '第七阵：虚影织界',
    text: '“把日、月、星三张卡都带来。三相结界只认完整的魔力光谱。”\n\n这是最后一道外层阵。穿过它，便是无声女王的王座。'
  },
  floor8: {
    speaker: '无声女王·诺克缇娅', portrait: 'final_queen', title: '终阵：无声王座',
    text: '“魔法制造差异，也制造争夺。我夺走你的魔力，是为了让所有咏唱归于沉默。”\n\n七枚核心在体内回应。璃已经能再次听见自己的魔力。'
  },
  bossCat: {
    speaker: '猫卫长·米露', portrait: 'cat_boss', title: '月影核心回收',
    text: '“结界命令……解除。拿走核心吧。女王在更高处，她把我们都写进了强制术式。”\n\n璃取回第一枚核心，重新感知到微弱魔力。'
  },
  bossFox: {
    speaker: '狐祝·绯叶', portrait: 'fox_boss', title: '森罗核心回收',
    text: '“你没有滥用钥匙，也没有被眼前的宝物诱导。这样的判断力，才配驾驭魔法。”'
  },
  bossWhale: {
    speaker: '深蓝歌姬·澜音', portrait: 'whale_boss', title: '潮汐核心回收',
    text: '澜音停止鲸歌，整层回廊恢复宁静。潮汐核心化作蓝色光流，修复了璃的魔力回路。'
  },
  bossSword: {
    speaker: '剑圣·塞蕾娜', portrait: 'sword_boss', title: '锋刃核心回收',
    text: '“固定数值并非冰冷。它让每一次选择都能被负责。”\n\n塞蕾娜收剑，让出了通路。'
  },
  bossDragon: {
    speaker: '龙姬·焰璃', portrait: 'dragon_boss', title: '赤焰核心回收',
    text: '龙火熄灭，强制契约断裂。焰璃把赤焰核心按进璃的掌心：“去把那个自以为能替所有人决定未来的女王拉下来。”'
  },
  bossAstral: {
    speaker: '天穹魔女·露米', portrait: 'astral_boss', title: '天穹核心回收',
    text: '“演算结果修正：你获胜的概率，已经从零变成了可观测值。”\n\n露米解除星图封锁，并交出第六枚核心。'
  },
  bossShadow: {
    speaker: '影织姬·鸦羽', portrait: 'shadow_boss', title: '虚影核心回收',
    text: '鸦羽的影线一根根断开。她低声说：“女王并不害怕你的力量。她害怕你证明——力量可以被选择，而不是被封存。”'
  },
  queenPhase: {
    speaker: '无声女王·诺克缇娅', portrait: 'final_queen', title: '最终术式展开',
    text: '女王的人形外壳崩裂，七层魔法阵同时逆转。她把自身与黯星核心融合，试图用无视防御的纯魔力抹去璃。\n\n这是最后一战。'
  },
  ending: {
    speaker: '绫星·璃', portrait: 'hero', title: '终章：魔法重新被选择',
    text: '黯星核心破碎，所有被强制控制的守卫恢复意识。\n\n璃没有夺走女王剩余的力量，而是解除了她对魔法的独占。魔法阵坍缩成清晨的星屑——从此，咏唱是否响起，将再次由每个人自己决定。'
  }
};
