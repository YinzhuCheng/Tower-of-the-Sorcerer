...
export const DIALOGUES = {
  prologue: {
    ...
    turns: [
      ...
      },
      {
        kind: 'narration',
        speaker: '旁白',
        text: '那一夜，灰港自己的码头和卫队根本来不及送走所有人。城边的高塔把七处设施全部打开：门廊认人，名册记下谁上哪艘船，导航台引船穿过风暴，巡卫护住通道，炉心替避难屋供暖，星镜把不同记录互相核对；最上层的印室则留下每道命令由谁签下、什么时候该停。'
      },
      {
        kind: 'narration',
        speaker: '旁白',
        text: '这一整套救援安排原本只需要撑过一个夜晚。最后一艘船若真到了北岸，船长就该把船号、人数、抵达时间和自己的签名一起送回来。灰港的人把那张纸叫“回执”。它不是一句“船已经开了”，而是北岸真正回过头来告诉高塔：“人到了，我们接住了。”只有等到这句话，高塔才该把警报一盏盏熄下去。'
      },
      {
        kind: 'narration',
        speaker: '旁白',
        text: '船队最终离开了灰港，北岸也在第二天收容了最后一批撤离者。三年后的今天，港口早已重建，旧船坞变成了新码头，孩子们也已经长大。可高塔的门始终没有打开，里面的警钟仍按三年前的节奏鸣响，仿佛那一夜从未结束。'
      },
      {
        kind: 'narration',
        speaker: '旁白',
        text: '站在塔门前的少女叫绫星·璃。三年前，她是护送撤离队伍的魔术师之一。她的拿手术式不是单纯用来攻击的咒文，而是一套七段式护航咏唱：七个段落分别帮助高塔辨认来者、整理名册、传递航路回音、保护通道、稳定供能、核对记录和追查命令来路。'
      },
      {
        speaker: '绫星·璃',
        portrait: 'hero', expression: 'guarded',
        text: '我最后一次站在这里时，灰港还在下雨。门外全是等船的人，塔里每一层都在喊不同的数字。我负责把七段咏唱接在一起，让七处岗位至少能互相听懂。那时候我以为，只要最后一艘船离港，一切就会结束。'
      },
      {
        kind: 'narration',
        speaker: '旁白',
        text: '可最后一艘船离港后，塔门没有再打开。高塔的守护者——无声女王·诺克缇娅——在风暴最猛烈时封死了通道。最初，她是怕失控魔力沿着开着的门追上撤离船，也怕断讯之后还有人被遗落在灰港。'
      },
      {
        kind: 'narration',
        speaker: '旁白',
        text: '封锁本该随着最后的回执解除，可诺克缇娅始终没有看见她认定有效的“全员安全”。登记网上还有四十七个名字写着“等待确认”。她不敢让警报停下——旧规警告她，只要救援结案，那些尚未确认的名字也可能一起被抹掉。'
      },
      {
        speaker: '绫星·璃',
        portrait: 'hero', expression: 'guarded',
        text: '北岸的纪念册里有北辰七号的完整乘员名单，连最后四十七个人后来住在哪条街都查得到。塔外，他们已经生活了三年；塔内，他们却仍被写成“下落未确认”，像从未走出那场风暴。'
      },
      {
        kind: 'narration',
        speaker: '旁白',
        text: '璃身边漂着一名银蓝色的小小精灵。她叫纱雾，是高塔旧通讯术式留下的“残响精灵”。战争结束后，大部分通讯精灵都随着传讯线熄灭而消散；纱雾却因为长期记着璃的护航咏唱和塔内回声，保留了自己的意识。'
      },
      {
        speaker: '残响精灵·纱雾',
        portrait: 'guide', expression: 'gentle',
        text: '先说明一件事：我不是一本会自己回答问题的全知档案。普通传讯线、低阶回声、哪一层还有残留记录，我大多能读；王庭以上被封存的原始签名和主权命令，我读不到。要是我什么都知道，我们就不用再进塔了。'
      },
      {
        speaker: '残响精灵·纱雾',
        portrait: 'guide', expression: 'watchful',
        text: '你带来的北岸纪念册能证明他们后来活着生活过，却只是三年后整理出的记录。高塔的旧规不肯拿它替代当夜原件。直到最近，我才从一段快要消散的导航残响里认出北辰七号的船号——那张原始回执确实进过塔，只是没有走到王庭。这是我们第一次知道，答案还在塔里。璃，结案不是把人和档案擦掉。该留下的是每个人后来去了哪里；该停下的，是只属于灾难那一夜的命令。'
      },
      {
        speaker: '残响精灵·纱雾',
        portrait: 'guide', expression: 'watchful',
        text: '诺克缇娅当年却只看见两条路：继续救援，或者撤销登记。她以为后一条意味着“把还没确认的人从纸上抹掉”，于是只能一次次选择继续等。最初是等一份迟到的回信；后来她已经看见守卫们在受苦，却仍不敢亲手让警报停下。'
      },
      {
        speaker: '绫星·璃',
      ...
      },
      {
        ...
        cgHold: 6,
        text: '还有你自己。三年前你赶来接应时，诺克缇娅已经快耗尽维持登记网的魔力。她没有杀你，而是强行把你的七段护航咏唱从咏唱脉络里拆开，分别嵌进七层阵眼。七段咏唱变成七枚核心，替她继续支撑整座塔。'
      },
      {
        speaker: '残响精灵·纱雾',
        portrait: 'guide', expression: 'focus',
        text: '你那七段咏唱，本来不是七种互不相干的魔法。月影认人，森罗认名字和船号，潮汐听船队回话，锋刃护住通道，赤焰照看避难屋，天穹拿不同记录互相核对，虚影追查命令从谁手里发出。它们连在一起时，会彼此提醒“这里不对”；被拆开以后，每一层都只会守着自己那一句话。'
      },
      {
        kind: 'narration',
        speaker: '旁白',
        text: '七枚核心又分别落在七名守护者身上。她们没有失去记忆：仍认得璃，也知道灰港的风暴早已过去，甚至能亲口指出命令哪里不对。可只要登记网仍把来者判作“妨碍救援”，核心就会牵动她们的身体，逼她们继续守门、挥剑、燃炉、鸣警。'
      },
      {
        speaker: '绫星·璃',
        portrait: 'hero', expression: 'guarded',
      ...
      },
      {
        speaker: '残响精灵·纱雾',
        portrait: 'guide', expression: 'gentle',
        text: '每拿回一枚核心，你也会听见那一层保留下来的原始记录。也许只是一段出发录音，也许只是一页名单；单独看都说不完整。把七份东西按时间接起来，我们才可能重新听清那一夜到底发生了什么。'
      },
      {
        speaker: '绫星·璃',
        portrait: 'hero', expression: 'guarded',
      ...
      },
      {
        speaker: '残响精灵·纱雾',
        portrait: 'guide', expression: 'focus',
        text: '第一层是月白门廊，米露守在那里。那里过去负责确认谁进塔、谁离塔。进去以后别把每一扇门、每一个敌人都当成必须解决的东西——卡牌、药露和魔晶都只有那么多，受的伤也不会因为上楼就自己消失。我们要把力气留给真正挡在证据前的人。'
      },
      {
        speaker: '绫星·璃',
        portrait: 'hero', expression: 'resolve',
        ...
        choices: [
          ...
          { label: '“先找能回收的资源。”', response: '璃抬头望向塔内：先看门、卡牌和补给的位置。补给不是拿来把每条岔路都走一遍的。留够力气，我们才能把真正被困住的人带出来。' }
        ]
      }
    ]
  },
  floor2: {
    ...
    turns: [
      ...
      { speaker: '残响精灵·纱雾', portrait: 'guide', expression: 'watchful', text: '能确定的是，北岸已经接到了北辰七号的人，高塔却仍把四十七个人记作失联。先别急着说是谁撒了谎——也可能是那份回答到了塔里，却没有走到该看的地方。' },
      { speaker: '绫星·璃', portrait: 'hero', expression: 'guarded', text: '米露证明船开了，森罗名册证明四十七个人都在船上。还差最后一句：船到了没有。把船长的回话找出来，“船已出发—四十七人在船上—船已抵达”这三份证据才真正闭合。' },
  ...
  floor3: {
    ...
    turns: [
      ...
      { speaker: '旁白', portrait: null, text: '深蓝回廊原本负责在风暴中给船队指路。航船离开灰港后，导航员会继续监听，直到船长报告抵达；收到报告后，潮汐回路再把原音送回名册和王庭，让名册、王庭与守卫都知道“这条航线已经完成”。' },
      { speaker: '深蓝歌姬·澜音', portrait: 'whale_boss', text: '我负责的就是把船带过风暴，再把船长的回话送回高塔。我的鲸歌不是为了好听，它会在雾里标出航向，也会把每一句回答一段不漏地带回来。北辰七号离开时，我从第一座浮标听到最后一座。' },
      { speaker: '深蓝歌姬·澜音', portrait: 'whale_boss', text: '船长先报船号，再报四十七名乘员，最后说“已抵达北岸，请结束紧急登记”。我听见了全部内容。可这段回话后来在送往王庭的途中被压成“等待复核”，潮汐核心又命令我继续发警报，好像那艘船从未靠岸。' },
  ...
  floor4: {
    ...
    turns: [
      ...
      { speaker: '绫星·璃', portrait: 'hero', expression: 'guarded', text: '她们不是不知道风暴结束，而是手里的命令根本没有“停止”两个字。先查是谁挖掉了那句话，再看改动发生在回执之前还是之后。' },
      { speaker: '绫星·璃', portrait: 'hero', expression: 'embers', text: '塞蕾娜，我已经带回船长原音。按原命令，你现在本该收剑。既然核心不让你停，我就先把第四段咏唱从它手里取回来，再读它保存的编辑记录。' },
      { speaker: '残响精灵·纱雾', portrait: 'guide', expression: 'focus', text: '庭院的锻炉机关会改变我们能走的路。辉月魔刃值得拿，但开门和交战都会付出代价。我们不是来把整座庭院扫干净的——先保证还能走到塞蕾娜面前。' }
    ]
  },
  floor5: {
    title: '第五阵：赤焰龙脉',
  ...
  floor6: {
    title: '第六阵：星镜书库',
    turns: [
      { speaker: '旁白', portrait: null, text: '赤焰炉记把时间线又补完整了一段：北辰七号的回执先进入高塔，随后王庭收到一条压过原令的“继续救援”新命令，供暖、警戒和登记因此没有转入结束阶段。第六层星镜书库保存的，正是这些命令彼此冲突时留下的核对痕迹。' },
      { speaker: '旁白', portrait: null, text: '天穹魔女·露米是书库的守护者，也是王庭的演算员。她的职责不是替女王决定对错，而是把不同选择会造成的后果算给她看。三年来，她的星镜里反复出现同样的两个结局。' },
      { speaker: '天穹魔女·露米', portrait: 'astral_boss', text: '第一条路：停止登记网。旧规会把所有“未结案”的名字当成临时条目抹掉。第二条路：继续登记网。名字留下，但守卫、炉火、警报和门锁也会继续服从那道救援令。' },
      { speaker: '天穹魔女·露米', portrait: 'astral_boss', text: '诺克缇娅三年前问过我，能不能只保存姓名和证据，不再继续让守卫战斗。我尝试把原始记录封存成不可涂改的档案，每一次演算走到“把记录单独保存”这一步，起源魔源都会拒绝访问。于是我只能给她看那两个都很糟的结果。' },
      { speaker: '旁白', portrait: null, text: '一面星镜把四十七个名字烧成空白，另一面则映着一次又一次重复的战斗。露米已经把这两个结局看了上千遍。她知道两边都在伤人，却一直找不到旧规愿意承认的第三条路。' },
      { speaker: '绫星·璃', portrait: 'hero', expression: 'guarded', text: '先把两件事分开：留下名字，不等于让救援永远继续。诺克缇娅一直以为只能二选一；我们现在要找的，是谁把第三条路锁住了。' },
      { speaker: '绫星·璃', portrait: 'hero', expression: 'resolve', text: '我们已经有船长原音、完整名册、被改过的封锁副本和异常供能记录。把这些放在同一条时间线上，星镜就能看出是哪一道更高的命令在回执出现之后插进来的。' },
      { speaker: '残响精灵·纱雾', portrait: 'guide', expression: 'focus', text: '先按新月、半月、满月唤醒三面星镜。能确定谁封住了归档入口，我们才有资格继续追那道命令的来路。' }
    ]
  },
  floor7: {
    title: '第七阵：虚影织界',
  ...
  bossWhale: {
    ...
    text: '鲸歌停下。潮汐核心回到璃手中，咏唱的脉络又稳了一些。'
  },
  bossSword: {
