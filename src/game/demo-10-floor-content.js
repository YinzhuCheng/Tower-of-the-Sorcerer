  ...
  Object.assign(dialogues, {
    ...
    floor8: {
      ...
      turns: [
        ...
        dialogueTurn('绫星·璃', 'hero', '所以取回魔力只是第一步。我得先解开王庭外环，再让女王亲眼看到北辰七号的抵达证据。', { expression: 'resolve' }),
    ...
    floor9: {
      ...
      turns: [
        ...
        dialogueTurn('残响精灵·纱雾', 'guide', '最后一道指令带着王座之外的黯星印权。诺克缇娅确实签过临时封塔令，却没有签下后来的“无限延长”。这两道命令不能混成一笔。', { expression: 'watchful' }),
    ...
    bossQueenPreDemo: dialogueSequence('第十阵：无声女王', 'night', [
      ...
      dialogueTurn('无声女王·诺克缇娅', 'final_queen', '最开始，我真的只想再等一会儿。我想，等回执来了，我就把七段咏唱还给你，再去向米露她们一个个道歉。', { expression: 'sorrow' }),
