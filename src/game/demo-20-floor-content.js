...
function installActTwoDialogues(dialogues) {
  Object.assign(dialogues, {
    ...
    floor18: dialogueSequence('第十八阵：澄空航渠', [
      ...
      dialogueTurn('影织姬·鸦羽', 'shadow_boss', '找到了。不是人在偷信，是这东西。顺序别弄反：回执比无限延长更早进塔，只是先卡在“等待复核”的支路里，没有送到王庭。后来断讯、上层新令生效，这东西才接过航渠，把那份仍在等待的原件拖进主权封印。它不读信，只认那句：“全员安全前，任何结案回执均不可信。”三年来，一直如此。'),
