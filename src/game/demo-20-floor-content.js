...
function installActTwoDialogues(dialogues) {
  Object.assign(dialogues, {
    floor11: dialogueSequence('第十一阵：复苏环廊', [
      ...
      dialogueTurn('无声女王·诺克缇娅', 'final_queen', '可我当时在王庭看到的只有两个按钮：“继续救援”和“撤销登记”。第二个按钮下面显示“未结案名字将被清除”。我以为停下命令，就是要把灰港的人再删掉一次。', { cg: '/assets/anime/cg/liyue-noctia-missing-fourth-step-cg.webp', cgHold: 3, expression: 'sorrow' }),
      ...
      dialogueTurn('无声女王·诺克缇娅', 'final_queen', '我的王庭只能执行上层命令。奥术主权者管理起源魔源，有权在断联时延长紧急状态；按旧规，他之后仍需航路、补给、名簿三席对同一份命令分别确认。', { expression: 'sorrow' }),
    ...
    floor18: dialogueSequence('第十八阵：澄空航渠', [
      ...
      dialogueTurn('旁白', null, '鸦羽将紫线一根根探入光流，又忽然合掌收紧。一只几乎透明的虚空先驱从绿光中跌出，胸口像信箱一样半开，里面卡着一枚带船长印记的回执。', { cg: '/assets/anime/cg/liyue-yayu-intercepted-receipt-cg.webp', cgHold: 3, kind: 'narration' }),
    ...
    floor20: dialogueSequence('第二十阵：起源魔源', [
      ...
      dialogueTurn('旁白', null, '奥术主权者说完后将手放在印戒下方。破裂的光环立刻沿着他的手腕收紧，晶核发出冰冷提示：“原签署人与命令共同封存，禁止单方撤回。”', { cg: '/assets/anime/cg/liyue-noctia-sovereign-cg.webp', cgHold: 5, kind: 'narration' }),
