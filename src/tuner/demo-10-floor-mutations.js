...
const NUMERIC_SPECS = Object.freeze([
  ...
  ['f8-hush-magic-down100', 'f8-hush-magic', 'hushCantor', 'magicPower', -100],
  ['f8-outer-atk-down6', 'f8-outer-atk', 'outerCrown', 'atk', -6],
  ['f8-outer-atk-up6', 'f8-outer-atk', 'outerCrown', 'atk', 6],
  ['f8-outer-atk-down42', 'f8-outer-atk', 'outerCrown', 'atk', -42],
  ...
  ['f9-null-magic-down100', 'f9-null-magic', 'nullCantor', 'magicPower', -100],
  ...
  ['f10-eclipse-mage-magic-down60', 'f10-eclipse-mage-magic', 'eclipseMage', 'magicPower', -60],
