import { analyzeV3C6CrossFloorLateShopCounterexampleHunt } from '../src/analyzer/event-order-c6-cross-floor-late-shop-counterexample-hunt.js';
...
const analysis = analyzeV3C6CrossFloorLateShopCounterexampleHunt({
...
const report = {
  schemaVersion: 1,
  model: 'distributed-pressure-v3-c6-cross-floor-late-shop-counterexample-hunt-v0.1',
  rebuild: {
...
if (json) process.stdout.write(`${JSON.stringify(report, null, 2)}\n`);
  ...
  console.log(`V3 late-shop hunt status=${analysis.status} exploit=${analysis.exploitFound} reference=${rebuilt.terminalHp}`);
