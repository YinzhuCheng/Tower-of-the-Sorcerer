import { analyzeV3C6ZeroDamageClosureCounterexampleHunt } from '../src/analyzer/event-order-c6-zero-damage-closure-counterexample-hunt.js';
...
const analysis = analyzeV3C6ZeroDamageClosureCounterexampleHunt({
...
const report = {
  schemaVersion: 1,
  model: 'distributed-pressure-v3-c6-zero-damage-closure-counterexample-hunt-v0.1',
  rebuild: {
...
if (json) process.stdout.write(`${JSON.stringify(report, null, 2)}\n`);
  ...
  console.log(`V3 closure hunt status=${analysis.status} exploit=${analysis.exploitFound} reference=${rebuilt.terminalHp}`);
