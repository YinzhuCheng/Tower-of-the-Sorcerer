...
await Promise.all([
  ...
  cp(new URL('../ui-v8-4.css', import.meta.url), new URL('../dist/ui-v8-4.css', import.meta.url)),
  cp(new URL('../ui-v8-5.css', import.meta.url), new URL('../dist/ui-v8-5.css', import.meta.url)),
