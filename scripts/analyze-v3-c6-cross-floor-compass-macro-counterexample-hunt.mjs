import { analyzeV3C6CrossFloorCompassMacroCounterexampleHunt } from '../src/analyzer/event-order-c6-cross-floor-compass-macro-counterexample-hunt.js';
...
const analysis = analyzeV3C6CrossFloorCompassMacroCounterexampleHunt({
...
const report = {
  schemaVersion: 1,
  model: 'distributed-pressure-v3-c6-cross-floor-compass-macro-counterexample-hunt-v0.1',
  rebuild: {
...
if (json) process.stdout.write(`${JSON.stringify(report, null, 2)}\n`);
  ...
  console.log(`V3 Compass-macro hunt status=${analysis.status} exploit=${analysis.exploitFound} reference=${rebuilt.terminalHp}`);
