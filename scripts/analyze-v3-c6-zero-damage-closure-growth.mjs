import { analyzeV3C6ZeroDamageClosureGrowth } from '../src/analyzer/event-order-c6-zero-damage-closure-growth.js';
...
const analysis = analyzeV3C6ZeroDamageClosureGrowth({
...
const report = {
  schemaVersion: 1,
  model: 'distributed-pressure-v3-c6-zero-damage-closure-growth-v0.1',
  rebuild: {
...
if (json) process.stdout.write(`${JSON.stringify(report, null, 2)}\n`);
  ...
  console.log(`V3 c6 zero-damage closure growth status=${analysis.status} reference=${rebuilt.terminalHp}`);
